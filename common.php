...
// s: cookiepay-plugin: https 전환
define('COOKIEPAY_USE_HTTPS', true); // https 사용시 true

if (COOKIEPAY_USE_HTTPS === true) {
    if (!isset($_SERVER['HTTPS'])) {
        $redirectHttpsUrl = str_replace("http://", "https://", $g5_path['url']);
        header("location: {$redirectHttpsUrl}");
    }
}
// e: cookiepay-plugin: https 전환
