...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <ul class="de_pg_tab">
                    ...
                    ?>
                    <li class="<?php if($isCookiepay !== false) echo 'tab-current'; ?>"><a href="#cookiepay_info_anchor" data-value="COOKIEPAY_AL" title="쿠키페이 선택하기">쿠키페이</a></li>
        ...
        <tr id="cookiepay_info_anchor">
            <th scope="row">
                <label for="cookiepay_de_pg_service">쿠키페이 결제대행사</label><br>
                <a href="<?php echo COOKIEPAY_JOIN_URL ?>" target="_blank" class="kg_btn">쿠키페이 신청하기</a>
            </th>
            <td>
                <?php echo help('쇼핑몰에서 사용할 쿠키페이 결제대행사를 선택합니다.'); ?>
                <ul>
                <?php
                ...
                foreach (COOKIEPAY_PG as $cookiepayPgCode => $cookiepayPgName) {
                    ...
                    echo '<label style="margin-right:15px;"><input type="radio" name="cookiepay_de_pg_service" id="cookiepay_de_pg_service_'.$i.'" value="'.$cookiepayPgCode.'" '.$checked.'> '.$cookiepayPgName.'</label>';
