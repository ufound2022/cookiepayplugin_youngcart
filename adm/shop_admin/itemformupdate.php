...
## 영카트 플러그인 > 정기(구독) > S
# it_type6 = '$it_type6', // 정기구독 상품
# last_pay_cnt = '$last_pay_cnt', // 총 납부횟수
## 영카트 플러그인 > 정기(구독) > ㄸ
...
## 영카트 플러그인 > 정기(구독) > S
if(is_checked('chk_ca_it_type'))                $ca_fields .= " , it_type1 = '$it_type1', it_type2 = '$it_type2', it_type3 = '$it_type3', it_type4 = '$it_type4', it_type5 = '$it_type5', it_type6 = '$it_type6' "; // 정기(구독)
if(is_checked('chk_ca_last_pay_cnt'))           $ca_fields .= " , last_pay_cnt = '$last_pay_cnt' ";
## 영카트 플러그인 > 정기(구독) > E
...
## 영카트 플러그인 > 정기(구독) > S
if(is_checked('chk_all_it_type'))                $all_fields .= " , it_type1 = '$it_type1', it_type2 = '$it_type2', it_type3 = '$it_type3', it_type4 = '$it_type4', it_type5 = '$it_type5', it_type6 = '$it_type6' "; // 정기(구독)
if(is_checked('chk_all_last_pay_cnt'))           $all_fields .= " , last_pay_cnt = '$last_pay_cnt' ";
## 영카트 플러그인 > 정기(구독) > E
