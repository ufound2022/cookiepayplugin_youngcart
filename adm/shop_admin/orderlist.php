...
<button 
    type="button" 
    class="btn btn_02" 
    style="position:absolute;right:0;margin-right:1.3rem;" 
    onClick="window.open('<?php echo COOKIEPAY_URL ?>/cookiepay.help.keyin.php', 'helpKeyinPopup1', 'width=500, height=450');"
>가맹점 수기결제 이용방법</button>
<?php 
// e: cookiepay-plugin 
?>
...
<div>
    ...
    <input type="radio" name="od_settle_case" value="수기결제" id="od_settle_case09" <?php echo get_checked($od_settle_case, '수기결제');  ?>>
    <label for="od_settle_case09">수기결제</label>
