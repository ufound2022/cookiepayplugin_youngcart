...
$subscription = (isset($_REQUEST['subscription']) && $_REQUEST['subscription']) ? 1 : "";
...
if ($sw_direct)
{
    if ($is_member)
    {
    	goto_url(G5_SHOP_URL."/orderform.php?sw_direct=$sw_direct&subscription=$subscription");
    }
    else
    {
    	goto_url(G5_BBS_URL."/login.php?url=".urlencode(G5_SHOP_URL."/orderform.php?sw_direct=$sw_direct&subscription=$subscription"));
    }
}
else
{
