	...
	<div id="sit_ov_wrap">
	    ...
	    <section id="sit_ov" class="2017_renewal_itemform">
	        ...
	        <div id="sit_ov_btn">
				...
				if(empty($is_member)) { 
				?>
	            <button type="button" onclick="alert('회원가입후 이용하여 주십시요');" value="정기" class="btn_submit">정기(구독)</button>
				<? } else { ?>
	            <button type="submit" onclick="document.pressed=this.value;" value="정기" class="sit_btn_buy">정기(구독)</button>
				<? } ?>
